...
В датасете `r n_names` уникальных имен, сравнивать их частотности сложно, поэтому мы использовали меру tf-idf, которая позволяет выделить ядро общее для двух групп и выделить имена, которые их отличают.
